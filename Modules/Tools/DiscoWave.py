...
class DiscoWave(Module):
    ...
    def define_output(self):
        ...
        bam                 = self.generate_unique_file_name("{}.discordant_reads.diff_chrom.tsv".format(sample_name))
        bam_idx             = bam + ".bai"
    ...
    def define_command(self):
        ...
        "--figure_output_dir {5} --min_read_pairs {6} --nr_cpus {7}".format(
            disco_wave, input_bam, sample_name, translocation_table, output_bam, figure_dir, min_read_pairs, nr_cpus)
