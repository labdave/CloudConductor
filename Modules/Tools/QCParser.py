...
class SamtoolsStats(_QCParser):

    def __init__(self, module_id, is_docker=False):
        super(SamtoolsStats, self).__init__(module_id, is_docker)

    def define_input(self):
        super(SamtoolsStats, self).define_input()
    ...
    def define_command(self):
        ...
        # Generate base command
        cmd = "%s SamtoolsStats -i %s -s %s" % (qc_parser, input_file, sample_name)
...
class StarStats(_QCParser):

    def __init__(self, module_id, is_docker=False):
        super(StarStats, self).__init__(module_id, is_docker)
    ...
    def define_command(self):
        ...
        # Generate base command
        cmd = "%s StarStats -i %s -s %s" % (qc_parser, input_file, sample_name)
