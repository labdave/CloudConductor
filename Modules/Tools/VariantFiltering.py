...
class VariantFiltering(Merger):
	...
	def define_command(self):
		...
		# add arguments
		cmd = " Rscript single_sample_VCF_merge_and_filter.R {0} {1} {2} {3} {4} {5} {6} {7}".format(haplotypecaller_vcf, strelka2_vcf, deepvariant_vcf, all_variants, filt_variants, wl_variants, single_sample_merge, sample_id)
